...
const DeactivationDoneScreen = ({ navigation }) => {
  return (
    <View style={{ flex: 1 }}>
      <View style={{ flex: 3 }}>
        ...
        <View style={{ flex: 3, margin: 20, alignItems: "center" }}>
          ...
          />
          <Text style={styles.text}>Predavanje deaktivirano.</Text>
        </View>
      </View>
      <View style={styles.buttonContainer}>
        <Pressable
          style={styles.pressable}
          onPress={() => navigation.navigate("Deaktivacija")}
        >
...
export default DeactivationDoneScreen;
